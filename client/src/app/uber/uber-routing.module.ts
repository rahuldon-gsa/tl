...
const routes: Routes = [
	{
		...
		children: [
			...
			{ path: 'ship', loadChildren: './ship/ship.module#ShipModule', canActivate: [AuthGuard] },
			...
			{ path: 'shipment', loadChildren: './../shared/components/shipment/shipment.module#ShipmentModule', canActivate: [AuthGuard] }
		]
	}
];
@NgModule({
